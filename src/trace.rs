...
/// JSON shape emitted by `pathlint trace --json`. Tagged enum with
/// the `kind` discriminator that 0.0.14 introduced (`"found"` or
/// `"not_found"`). Schema is generated by
/// `cargo run --bin gen_trace_schema` and shipped at
